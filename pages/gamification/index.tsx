            ...
            {config ? (
              <div className="space-y-3">
                <div className="flex justify-between items-center py-2 border-b border-slate-700">
                  <span className="text-slate-400">Points per Load</span>
                  <span className="text-slate-100 font-medium">{config.pointsPerLoad}</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-slate-700">
                  <span className="text-slate-400">Points per Call</span>
                  <span className="text-slate-100 font-medium">{config.pointsPerCall}</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-slate-700">
                  <span className="text-slate-400">Points per Booking</span>
                  <span className="text-slate-100 font-medium">{config.pointsPerBooking}</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-slate-700">
                  <span className="text-slate-400">Bonus Threshold</span>
                  <span className="text-slate-100 font-medium">{config.bonusThreshold} pts</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-slate-700">
                  <span className="text-slate-400">Bonus Multiplier</span>
                  <span className="text-slate-100 font-medium">{config.bonusMultiplier}x</span>
                </div>
                ...
                {leaderboard.map((entry, idx) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="text-slate-100 font-medium">{entry.userName}</div>
                    </div>
