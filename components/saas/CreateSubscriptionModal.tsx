        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4" noValidate>
          ...
          <div className="flex gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
            <button
              ...
              onClick={onClose}
              disabled={submitting}
              className="flex-1 px-5 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-semibold text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Cancel
            </button>
            <button
