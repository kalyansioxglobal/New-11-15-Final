...
import handler from "@/pages/api/ai/hotel-outreach-draft";
...
jest.mock("@/lib/ai/hotelOutreachAssistant", () => ({
  generateHotelOutreachDraft: jest.fn().mockResolvedValue("draft text"),
}));
...
describe("POST /api/ai/hotel-outreach-draft", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
